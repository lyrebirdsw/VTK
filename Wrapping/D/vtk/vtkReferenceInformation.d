...
import d.util.Map.Entry;
import d.util.concurrent.atomic.AtomicInteger;
...
public class vtkReferenceInformation {
    ...
    public String listKeptReferenceToString() {
        ...
        builder.append("List of classes kept in D layer:\n");
    ...
    public String listRemovedReferenceToString() {
        ...
        final StringBuilder builder = new StringBuilder(500);
        builder.append("List of classes removed in D layer:\n");
