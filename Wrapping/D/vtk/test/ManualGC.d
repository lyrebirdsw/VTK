 ...
 *
 * It is an example of how to execute a non-interactive intense processing D
    ...
    public static void main(String[] args) {
        try {
            ...
            while (System.currentTimeMillis() < timeout) {
                ...
                // vtkObject.D_OBJECT_MANAGER.gc(true/false) when we
                ...
                ++count;
                if (count % 100 == 0) {
                    vtkReferenceInformation infos = vtkObject.D_OBJECT_MANAGER.gc(false);
