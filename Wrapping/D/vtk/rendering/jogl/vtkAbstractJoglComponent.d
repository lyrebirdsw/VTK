...
import dx.media.opengl.GLAutoDrawable;
import dx.media.opengl.GLContext;
import dx.media.opengl.GLEventListener;
 ...
 */
public class vtkAbstractJoglComponent<T extends d.awt.Component> extends vtkAbstractComponent<T> {
    ...
    public vtkAbstractJoglComponent(vtkRenderWindow renderWindowToUse, T glContainer) {
        ...
        this.glEventListener = new GLEventListener() {
            ...
            public void dispose(GLAutoDrawable drawable) {
                ...
                vtkObject.D_OBJECT_MANAGER.gc(false);
            }
        };
