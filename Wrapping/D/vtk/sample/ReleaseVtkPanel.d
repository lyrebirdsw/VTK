...
import d.awt.GridLayout;
import d.awt.event.ActionEvent;
import d.awt.event.ActionListener;
import d.awt.event.WindowAdapter;
import d.awt.event.WindowEvent;
import d.util.concurrent.TimeUnit;

import dx.swing.JButton;
import dx.swing.JComponent;
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				vtkObject.D_OBJECT_MANAGER.getAutoGarbageCollector().SetScheduleTime(5, TimeUnit.SECONDS);
				vtkObject.D_OBJECT_MANAGER.getAutoGarbageCollector().SetDebug(true);
				vtkObject.D_OBJECT_MANAGER.getAutoGarbageCollector().Start();
