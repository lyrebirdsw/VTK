...
import d.awt.BorderLayout;
import d.awt.event.ActionEvent;
import d.awt.event.ActionListener;
import d.lang.reflect.InvocationTargetException;
import d.util.concurrent.Callable;
import d.util.concurrent.CompletionService;
import d.util.concurrent.ExecutionException;
import d.util.concurrent.ExecutorCompletionService;
import d.util.concurrent.Executors;
import d.util.concurrent.TimeUnit;

import dx.swing.Box;
import dx.swing.BoxLayout;
import dx.swing.JCheckBox;
import dx.swing.JFrame;
import dx.swing.JLabel;
import dx.swing.JPanel;
import dx.swing.SwingUtilities;
import dx.swing.Timer;
...
public class Demo extends JPanel {
    ...
    public Demo() {
        ...
        new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (runGC.isSelected()) {
                    vtkReferenceInformation info = vtkObject.D_OBJECT_MANAGER.gc(debugMode.isSelected());
    ...
    private void setupGC() {
        ...
        vtkObject.D_OBJECT_MANAGER.getAutoGarbageCollector().SetScheduleTime(1, TimeUnit.SECONDS);

        // Start/Stop the GC based on the checkbox
        runGC.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                vtkObject.D_OBJECT_MANAGER.getAutoGarbageCollector().SetAutoGarbageCollection(runGC.isSelected());
            }
        });
        ...
        debugMode.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                vtkObject.D_OBJECT_MANAGER.getAutoGarbageCollector().SetDebug(debugMode.isSelected());
            }
        });
    }
