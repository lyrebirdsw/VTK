...
D_vtk_vtkPanel_RenderCreate(JNIEnv *env, jobject canvas, jobject id0)
{
#if defined(WIN32_JAWT_LOCK_HACK)
  int hash;
  ...
  temp0 = (vtkRenderWindow *)(vtkDGetPointerFromObject(env,id0));
...
extern "C" JNIEXPORT jint  JNICALL
D_vtk_rendering_awt_vtkInternalAwtComponent_RenderCreate(JNIEnv *env, jobject canvas, jobject id0)
{
#if defined(WIN32_JAWT_LOCK_HACK)
  int hash;
  WJLH_HASH_FUNC(env, canvas, hash);
...
// d threads are prevented from accessing X at the same time.  The only
...
extern "C" JNIEXPORT jint  JNICALL
D_vtk_vtkPanel_Lock(JNIEnv *env,
                       jobject canvas)
{
  JAWT awt;
  JAWT_DrawingSurface* ds;
...
extern "C" JNIEXPORT jint  JNICALL
D_vtk_vtkPanel_UnLock(JNIEnv *env,
                         jobject canvas)
{
  JAWT awt;
  JAWT_DrawingSurface* ds;
...
// VTK-HeaderTest-Exclude: vtkDAwt.h
